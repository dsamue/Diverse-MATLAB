...
reconstructedFrame = reverseBlkMatching(motionVectors, differenceBlocks, referenceImage, numPatchWidth, numPatchHeight);

imshow(uint8(reconstructedFrame))
